<div class="mainCont">
    <div class="rowContainer">
        ...
        <div class="row rowServices">
            ...
            <div class="txtCont servicesTxt">
                <h1>Virus Removal</h1>
                <p>If your device is infected with a virus, a removal is needed. Viruses such as Spyware, Ransomware, and more can be removed.</p><br>
                <a href="?page=pricing&product=removal">View Price</a>
            </div>
        </div>
        <div class="row rowServices">
            <div class="txtCont servicesTxt">
            ...
            <div class="txtCont servicesTxt">
                ...
                <p>If a problem is deemed impossible or impractical to fix, the best option to get a computer back is to reset it back to the default factory settings.</p><br>
                <a href="?page=pricing&product=factory">View Price</a>
            </div>
        </div>
    </div>
</div>
